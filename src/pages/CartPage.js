...
const stripePromise = loadStripe("pk_test_51LgAbpSHIVrnfeGHpZbp8XY1egQuWBeZdWjZKe33BN5IYwX0yDBmte44X1QQkjM4LLF2Vft6iVd7FWPZGUGtZdb500HF3AHr4k");
...
function CartPage() {
    ...
    function handleDecrease(product) {
        ...
        if (quantity <= 0) return alert("Please add your required product quantity");
                                    ...
                                    {cart.map((item) => (
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <img src={item.pictures[0].url} alt="product" style={{ width: 100, height: 100, objectFit: "cover" }} />
                                            </td>
                                            <td>${item.price}</td>
                                            <td>
